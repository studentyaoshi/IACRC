...
python purning.py ${2}.imiss ${2}.keep.fam ${IMR} ${2}.lmiss ${CR} ${2}.frq ${MAF} ${2}.hardy ${HWE} ${2}.ld ../result/${1}/${1}.pairs.uniq ../result/${1}/${1}.pairs.purning

plink --bfile ${2} --keep ${2}.keep.fam --make-bed --out ${2}.keep

rm ${2}.log ${2}.frq ${2}.hwe ${2}.lmiss ${2}.imiss ${2}.hh ${2}.exon.snp ${2}.keep.fam ${2}.hardy
